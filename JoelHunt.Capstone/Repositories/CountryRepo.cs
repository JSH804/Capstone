    ...
    public class CountryRepo : ICountryService
    {
        ...
        public int CreateCountry(Country country)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "INSERT INTO country(country,createDate,createdBy,lastUpdate,lastUpdateBy)VALUES(@country,@date,@tutor,@date,@tutor)";
                cmd.Parameters.AddWithValue("@country", country.CountryName);
                cmd.Parameters.AddWithValue("@tutor", country.CreatedBy);
