    ...
    public class AddressRepo : IAddressService
    {
        ...
        public int CreateAddress(Address address)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "INSERT INTO address(address,address2,cityId,postalCode,phone,createDate,createdBy,lastUpdate,lastUpdateBy)VALUES(@address,@addressTwo,@cityId,@postalCode,@phone,@date,@tutor,@date,@tutor)";
                ...
                cmd.Parameters.AddWithValue("@tutor", address.CreatedBy);
